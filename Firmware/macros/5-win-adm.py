...
app = {               # REQUIRED dict, must be named 'app'
    ...
    'macros' : [      # List of button macros...
        ...
        # 1st row ----------
        (0x200000, 'run', [Keycode.WINDOWS,'r']),
        (0x202000, 'rdp', [Keycode.WINDOWS,'r',-Keycode.WINDOWS, 0.5 , 'mstsc\n']),
        (0x002000, 'NET', [Keycode.WINDOWS,'r',-Keycode.WINDOWS, 0.5, 'control.exe /name Microsoft.NetworkAndSharingCenter\n']),
        # 2nd row ----------
